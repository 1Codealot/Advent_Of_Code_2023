...
def extrapolate(history):
    ...
    # print(historyDifferences[0])

    #historyDifferences.insert(0, 0)

    # Go through backwards, appending
    for x in range(len(historyDifferences)-1, 0, -1):
        historyDifferences[x-1].insert(0, historyDifferences[x-1][0] - historyDifferences[x][0])

    return historyDifferences[0][0]
